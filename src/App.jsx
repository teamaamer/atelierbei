...
const Navbar = ({ scrollY }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 backdrop-blur-md" style={{ backgroundColor: 'rgba(243, 239, 235, 0.85)' }}>
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between h-16">

          <div className="hidden md:flex items-center space-x-12 flex-1 justify-center">
            <button onClick={() => scrollToSection('home')} className="text-sm font-light hover:opacity-70 transition-all duration-300" style={{ color: '#b5945c' }}>
              Home
            </button>
            <button onClick={() => scrollToSection('about')} className="text-sm font-light hover:opacity-70 transition-all duration-300" style={{ color: '#b5945c' }}>
              About
            </button>
            <button onClick={() => scrollToSection('services')} className="text-sm font-light hover:opacity-70 transition-all duration-300" style={{ color: '#b5945c' }}>
              Services
            </button>
            <button onClick={() => scrollToSection('results')} className="text-sm font-light hover:opacity-70 transition-all duration-300" style={{ color: '#b5945c' }}>
              Results
            </button>
            <button onClick={() => scrollToSection('reviews')} className="text-sm font-light hover:opacity-70 transition-all duration-300" style={{ color: '#b5945c' }}>
              Reviews
            </button>
            <button onClick={() => scrollToSection('contact')} className="text-sm font-light hover:opacity-70 transition-all duration-300" style={{ color: '#b5945c' }}>
              Contact
            </button>
          </div>

          <button className="px-8 py-2.5 rounded-full text-sm font-light tracking-wide 
...
const HeroSection = ({ scrollY }) => {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-ivory">
      <div className="absolute top-1/4 -right-32 z-0 opacity-[0.15]">
        <video 
          autoPlay 
          loop 
          muted 
      ...
      <div className="absolute top-1/3 -left-32 z-0 opacity-[0.12]">
        <video 
          autoPlay 
          loop 
          muted 
          playsInline 
          className="w-[400px] h-auto transform scale-x-[-1]"
        >
          <source src="/flowervid.mp4" type="video/mp4" />
        </video>
      </div>
